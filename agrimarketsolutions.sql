CREATE DATABASE  IF NOT EXISTS `agrimarketsolutions` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `agrimarketsolutions`;
-- MySQL dump 10.13  Distrib 8.0.41, for Win64 (x86_64)
--
-- Host: localhost    Database: agrimarketsolutions
-- ------------------------------------------------------
...
CREATE TABLE `reviews` (
  ...
  KEY `customer_id` (`customer_id`),
  KEY `product_id` (`product_id`),
  CONSTRAINT `reviews_ibfk_1` FOREIGN KEY (`customer_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE,
...
CREATE TABLE `staff_tasks` (
  ...
  CONSTRAINT `staff_tasks_ibfk_1` FOREIGN KEY (`staff_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES (1,'JiaxianGan','$2y$10$4Oguzq5PIm7Z/DQ2JxrWA.g/k/cp4dHLEuJIPJhVN0X7QBEaylpzi','xian20030703@gmail.com',NULL,'customer','2025-03-07 03:49:36'),(2,'Jiaxian','$2y$10$ciSAOeGfKhp/xjFgCgVa.elWf0sBZG0AqAW6rlK8IxPGqz0n4XsgS','jiaxiangan0703@gmail.com',NULL,'customer','2025-03-07 04:00:09');
...
-- Dump completed on 2025-03-14 12:15:42
